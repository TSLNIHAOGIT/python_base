...
from coroutine_process.flags2_common import main, HTTPStatus  # <2>
from coroutine_process.flags2_sequential import download_one  # <3>
...
def download_many(cc_list, base_url, verbose, concur_req):
    ...
    #使用多进程
    with futures.ProcessPoolExecutor(max_workers=concur_req) as executor:  # <6>
    #使用多线程
...
if __name__ == '__main__':
    main(download_many,default_concur_req=5, max_concur_req=10)
